...
const Form = () => {
  ...
  return (
    <div className="form">
      <div className={state.error.day ? 'input__wrapper warning' : 'input__wrapper'}>
        <span>day</span>
        <MyInput value={state.inputValue.day} placeHolder="DD" />
        {state.error.day ? <span className='warning--text'>{state.error.day}</span> : null}
      </div>
      <div className={state.error.month ? 'input__wrapper warning' : 'input__wrapper'}>
        <span>month</span>
      ...
      <div className={state.error.years ? 'input__wrapper warning' : 'input__wrapper'}>
        <span>year</span>
